...
<div style={{width:"100%",background:"rgba(2,8,16,0.97)",padding:"80px 20px",textAlign:"center"}}><p style={{color:"rgba(155,210,248,0.6)",fontSize:12,letterSpacing:"0.15em",textTransform:"uppercase",marginBottom:8,fontFamily:"DM Sans, sans-serif"}}>Simple Pricing</p><h2 style={{color:"var(--cream)",fontSize:"clamp(28px,5vw,48px)",fontFamily:"Bebas Neue, sans-serif",marginBottom:40,letterSpacing:3}}>START FREE. SCALE WHEN READY.</h2><div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(200px,1fr))",gap:16,maxWidth:800,margin:"0 auto 40px"}}><div style={{background:"rgba(68,187,255,0.05)",border:"1px solid rgba(68,187,255,0.15)",borderRadius:16,padding:"24px 16px"}}><div style={{color:"var(--cream)",fontFamily:"Bebas Neue, sans-serif",fontSize:20,letterSpacing:2,marginBottom:4}}>Free</div><div style={{color:"var(--blue)",fontFamily:"Bebas Neue, sans-serif",fontSize:36,lineHeight:1}}>£0</div><div style={{color:"rgba(155,210,248,0.5)",fontSize:12,marginTop:8}}>7-day Pro trial included</div></div><div style={{background:"rgba(68,187,255,0.10)",border:"2px solid rgba(68,187,255,0.40)",borderRadius:16,padding:"24px 16px",position:"relative"}}><div style={{position:"absolute",top:-10,left:"50%",transform:"translateX(-50%)",background:"var(--blue)",color:"#000",fontSize:10,fontWeight:800,padding:"3px 12px",borderRadius:100,letterSpacing:2,textTransform:"uppercase"}}>Popular</div><div style={{color:"var(--cream)",fontFamily:"Bebas Neue, sans-serif",fontSize:20,letterSpacing:2,marginBottom:4}}>Pro</div><div style={{color:"var(--blue)",fontFamily:"Bebas Neue, sans-serif",fontSize:36,lineHeight:1}}>£35<span style={{fontSize:14}}>/mo</span></div><div style={{color:"rgba(155,210,248,0.5)",fontSize:12,marginTop:8}}>Unlimited AI production</div></div><div style={{background:"rgba(68,187,255,0.05)",border:"1px solid rgba(68,187,255,0.15)",borderRadius:16,padding:"24px 16px",opacity:0.6}}><div style={{color:"var(--cream)",fontFamily:"Bebas Neue, sans-serif",fontSize:20,letterSpacing:2,marginBottom:4}}>Studio</div><div style={{color:"var(--blue)",fontFamily:"Bebas Neue, sans-serif",fontSize:36,lineHeight:1}}>£65<span style={{fontSize:14}}>/mo</span></div><div style={{color:"rgba(155,210,248,0.5)",fontSize:12,marginTop:8}}>Coming soon</div></div></div><button onClick={()=>router.push("/pricing")} style={{padding:"16px 48px",background:"rgba(68,187,255,0.15)",border:"2px solid rgba(68,187,255,0.60)",borderRadius:20,color:"#ffffff",fontFamily:"DM Sans, sans-serif",fontSize:15,fontWeight:800,cursor:"pointer",letterSpacing:"0.06em",textTransform:"uppercase"}}>View Full Pricing and Compare Plans</button></div>
    </>
  );
