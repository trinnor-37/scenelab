...
<div style={{textAlign:"center",padding:"48px 20px 0",width:"100%"}}><p style={{color:"rgba(155,210,248,0.7)",fontSize:13,marginBottom:14,fontFamily:"DM Sans, sans-serif",letterSpacing:"0.05em"}}>Start free — 7-day Pro trial included</p><button onClick={()=>router.push("/pricing")} style={{display:"block",margin:"0 auto",padding:"16px 48px",background:"rgba(68,187,255,0.15)",border:"2px solid rgba(68,187,255,0.60)",borderRadius:20,color:"#ffffff",fontFamily:"DM Sans, sans-serif",fontSize:15,fontWeight:800,cursor:"pointer",letterSpacing:"0.06em",textTransform:"uppercase"}}>View Pricing and Plans</button></div>
          </div>
        </div>
      </div>
    </>
