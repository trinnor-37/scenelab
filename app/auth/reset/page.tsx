...
export default function ResetPage() {
  ...
  return (
    <div style={{minHeight:"100vh",display:"flex",alignItems:"center",justifyContent:"center",background:"#020810",fontFamily:"DM Sans, sans-serif",padding:"20px"}}>
      <div style={{width:"100%",maxWidth:420,background:"#050e1c",border:"1px solid rgba(68,187,255,0.13)",borderRadius:20,padding:"40px 32px"}}>
        <div style={{fontFamily:"Bebas Neue, sans-serif",fontSize:28,letterSpacing:4,marginBottom:8,color:"#ede3c0"}}>
          SCENE<span style={{color:"#44bbff"}}>BLOC</span>
        </div>
        <div style={{fontSize:20,fontWeight:700,color:"#eef5ff",marginBottom:8}}>Set new password</div>
        <div style={{fontSize:14,color:"rgba(155,210,248,0.55)",marginBottom:28}}>Enter your new password below.</div>
        ...
        {!ready ? (
          <div style={{color:"rgba(155,210,248,0.55)",fontSize:14}}>Verifying reset link...</div>
        ) : (
          <>
